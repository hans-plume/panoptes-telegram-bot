...
A full 24-hour period contains 96 data points (4 per hour × 24 hours).
...
| Command | Description |
|---------|-------------|
| `/status` | Overall network health report with action buttons |
| `/stats` | Connection status history (3h, 24h, 7d views) |
